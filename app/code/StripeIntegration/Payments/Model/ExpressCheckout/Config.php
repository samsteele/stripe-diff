...
class Config
{
    ...
    private $isAmazonPayEnabled = null;
    ...
    )
    {
        ...
        $this->isEnabled = $this->isApplePayEnabled || $this->isGooglePayEnabled || $this->isLinkEnabled || $this->isPaypalEnabled || $this->isAmazonPayEnabled;
